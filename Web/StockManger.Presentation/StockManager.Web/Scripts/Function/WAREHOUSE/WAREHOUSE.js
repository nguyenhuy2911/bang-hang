...
function WAREHOUSE() {
    debugger;
    this.$input = new InputControl(FUNCTIONENUM.WAREHOUSE.WAREHOUSE_LIST);
}

WAREHOUSE.prototype = new BaseFunction(FUNCTIONENUM.WAREHOUSE.WAREHOUSE_LIST);
...
WAREHOUSE.prototype.bindData = function (response) {
    debugger;
    var dataList = [];
    var rowCount = 0;
    var rowOrderNo = 1;
...
WAREHOUSE.prototype.newWarehouseForm = function () {

    LoadPoupForm("/warehouse-new");
}

function newWarehouseForm() {
    var module = new WAREHOUSE();
    module.newWarehouseForm();
